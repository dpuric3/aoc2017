const string = `414	382	1515	319	83	1327	116	391	101	749	1388	1046	1427	105	1341	1590
...
function part1(string) {
    ...
    // for (row of num) { arr.push(row.replace(/\s+/g, '')) }

    for (row of num) {
        var tmparr = row.split('\t');
        var arr = []
        for (row of tmparr) {
            arr.push(parseInt(row, 10));
        }
